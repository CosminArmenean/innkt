      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-2xl bg-white rounded-xl shadow-2xl border border-gray-200 popover-card">
          ...
          {!canRepost && (
            <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-red-800 font-medium">Cannot repost this content</span>
              </div>
              <p className="text-red-700 text-sm mt-1">
                {hasReposted ? 'You have already reposted this post' : 
                 repostInfo?.reason || 'Rate limit exceeded or content restrictions apply'}
              </p>
              {repostInfo && (
                <p className="text-red-600 text-xs mt-2">
                  Reposts in last hour: {repostInfo.repostCountLastHour}/{repostInfo.maxRepostsPerHour}
                </p>
              )}
            </div>
          )}
            ...
            <div className="flex space-x-4">
              ...
              >
                <div className="text-center">
                  ...
                  <h4 className="font-medium">Simple Repost</h4>
                  <p className="text-sm opacity-75">Share as-is to your followers</p>
                </div>
              </button>
              ...
              >
                <div className="text-center">
                  <div className="text-2xl mb-2">💬</div>
                  <h4 className="font-medium">Quote Repost</h4>
                  <p className="text-sm opacity-75">Add your thoughts</p>
                </div>
              </button>
            </div>
          </div>
            ...
            <div className="mb-4">
              ...
              <div className="flex justify-between items-center mt-1">
                <span className="text-xs text-gray-500">
                  {280 - quoteText.length} characters remaining
                </span>
        ...
        <div className="flex items-center justify-between p-6 border-t border-gray-100 bg-gray-50">
          <div className="text-sm text-gray-600">
            {repostType === 'simple' ? (
              <span>📢 This will appear in your followers' feeds</span>
            ) : (
              <span>💭 Your comment will appear above the original post</span>
            )}
          </div>
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  ...
                  <span>{repostType === 'quote' ? 'Quote Repost' : 'Repost'}</span>
                </>
              )}
            </button>
          </div>
