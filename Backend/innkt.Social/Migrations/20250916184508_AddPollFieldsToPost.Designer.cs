...
namespace innkt.Social.Migrations
{
    ...
    [Migration("20250916184508_AddPollFieldsToPost")]
    partial class AddPollFieldsToPost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("innkt.Social.Models.Post", b =>
                {
                    ...
                    b.Property<int?>("PollDuration")
                        .HasColumnType("integer")
                        .HasColumnName("PollDuration");

                    b.Property<DateTime?>("PollExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("PollExpiresAt");
